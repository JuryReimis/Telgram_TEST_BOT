...
class TestCreator:
    ...
    question_registered = 0     # Сколько вопросов уже зарегистрировано
    ...
    @dp.message_handler(Command("cancel"),
                        state=[CreateNameTest.Name_is_creating, CreateNameTest.Get_tests_length, CreateNameTest.Question_selection,
